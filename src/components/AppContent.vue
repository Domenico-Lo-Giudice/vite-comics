...
<template>
  <section class="FirstSection">
    <div id="FirstSectionUP">
      <div class="container-jumbo"></div>
    </div>
    <div id="FirstSectionDOWN">
...
#FirstSectionDOWN .card .img {
  height: 80%;
  width: 100%;
  background-size: cover;
}

#FirstSectionDOWN .card .testo {
  height: 40%;
  width: 100%;
  background-color: #1c1c1c;
  color: white;
